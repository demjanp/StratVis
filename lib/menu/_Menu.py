...
from lib.toolbar.ExportChanges import ExportChanges
from lib.toolbar.ExportXLS import ExportXLS
from lib.toolbar.ExportPDF import ExportPDF
...
MENUS = {
	"Data": [Connect, Save, SaveAsFile, Deposit, Separator, ClearRecent,],
	"Edit": [Undo,],
	"Export": [ExportChanges, ExportXLS, ExportPDF,],
	"Help": [About,],
}
