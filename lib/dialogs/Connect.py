...
class Connect(DConnect):
	...
	def logo(self):
		...
		logo_frame.layout().setContentsMargins(3, 3, 3, 3)
		logo_frame.layout().addWidget(ClickableLogo("res/sv_logo.svg", "https://github.com/demjanp/StratVis", alignment = QtCore.Qt.AlignCenter))
