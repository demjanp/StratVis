...
class AboutDialog(Dialog):
	...
	def set_up(self):
		...
		self.logo.setPixmap(QtGui.QPixmap("res/sv_logo.svg"))
		path = os.path.join(os.path.dirname(__file__), "..", "THIRDPARTY.TXT").replace("\\", "/")
		self.label = QtWidgets.QLabel('''
<h2>StratVis</h2>
<h4>Stratigraphy visualization and editing</h4>
<p>Version %s (%s)</p>
...
<p><a href="https://github.com/demjanp/StratVis">Home page</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="%s">Third party libraries</a></p>
